...
public class WarnLogProcessor extends LogProcessor {
    ...
    private final LogLevel loggerLevel = LogLevel.WARN;

    public WarnLogProcessor(LogProcessor nextLogProcessor, LogSink logSink, LogLevel loggingLevel, TimeFormat timeFormat) {
