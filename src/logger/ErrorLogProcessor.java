...
public class ErrorLogProcessor extends LogProcessor {
    ...
    private final LogLevel loggerLevel = LogLevel.ERROR;

    public ErrorLogProcessor(LogProcessor nextLogProcessor, LogSink logSink, LogLevel loggingLevel, TimeFormat timeFormat) {
