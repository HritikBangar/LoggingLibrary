...
public class FatalLogProcessor extends LogProcessor {
    ...
    private final LogLevel loggerLevel = LogLevel.FATAL;

    public FatalLogProcessor(LogProcessor nextLogProcessor, LogSink logSink, LogLevel loggingLevel, TimeFormat timeFormat) {
